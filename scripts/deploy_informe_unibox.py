...
# -*- coding: utf-8 -*-
"""
Deploy FTP - INFORME UNIBOX
Sube el informe de auditoría INFORME_UNIBOX.md a /outbound/ remoto.
Verifica cada subida (size + MD5) tras el upload.
NO ejecuta SMTP, cron ni ninguna otra operación.
"""
import ftplib
import os
import sys
...
# Archivo a desplegar (relativo a outbound/)
DEPLOY_FILES = [
    "INFORME_UNIBOX.md",
]
...
def main():
    ...
    with open(os.path.join("backups_deploy", "deploy_informe_unibox_manifest.txt"), "w") as f:
