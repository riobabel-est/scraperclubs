...
# -*- coding: utf-8 -*-
"""
Deploy FTP - SINCRONIZACIÓN IMAP LIGERA AL CARGAR DASHBOARD
Sube SOLO los archivos modificados para la carga limpia de datos IMAP:
  - dashboard.php          (integra imap_procesar_todas_cuentas_ligero al cargar)
  - inc/imap_respuestas.php (añade funciones ligeras: _ligero)
1. Crea backup remoto de los archivos a sobrescribir.
2. Sube los archivos.
...
# SOLO los archivos modificados para la sincronización IMAP ligera
DEPLOY_FILES = [
    "dashboard.php",
...
def main():
    ...
    remote_bk = f"{REMOTE_BACKUP_BASE}/outbound_imap_ligero_{ts}"
    ...
    with open(os.path.join("backups_deploy", "imap_ligero_deploy_manifest.txt"), "w") as f:
    ...
    print("Deploy IMAP ligero completado.")
