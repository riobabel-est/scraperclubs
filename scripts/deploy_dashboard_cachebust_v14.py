...
# -*- coding: utf-8 -*-
"""
Deploy FTP - SUBE SOLO dashboard.php (cache-busting app.js v=14)
Corrige el error Alpine "rsSyncing is not defined" forzando al navegador
a recargar js/app.js (que ya contiene rsSyncing) con un nuevo query string.
1. Backup remoto de dashboard.php.
2. Sube dashboard.php.
3. Verifica MD5.
NO toca stats.db ni otros archivos.
"""
import ftplib
import os
import sys
...
def main():
    ...
    remote_bk = f"{REMOTE_BACKUP_BASE}/outbound_cachebust_v14_{ts}"
    ...
    with open(os.path.join("backups_deploy", "cachebust_v14_manifest.txt"), "w") as f:
    ...
    print("Deploy cache-busting v14 completado.")
