...
<?php if($waLink&&$hasWa):?><a href="<?=escHtml($waLink)?>" target="_blank" @click.stop class="text-emerald-400 hover:text-emerald-300 font-semibold" title="WhatsApp"><i data-lucide="message-circle" class="w-4 h-4 inline"></i> WA</a><?php endif;?>
