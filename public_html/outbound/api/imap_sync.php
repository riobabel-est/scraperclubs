<?php
/**
 * imap_sync.php — RUNNER WEB PERMANENTE para Cron Job (SiteGround)
 * ==============================================================================
 ...
 *
 * NOTA DE UBICACIÓN: Este runner vive en `api/` (NO en `cli/`) porque el
 * `.htaccess` de outbound bloquea el acceso web directo a `cli/` (RewriteRule
 * ^cli/ - [F,L]). Al estar en `api/`, es accesible por HTTP para el cron job.
 *
 ...
 *
 * USO (Cron Job HTTP):
 *   GET .../api/imap_sync.php?token=SECRET&apply=1
 *
