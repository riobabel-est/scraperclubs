...
// 'respuesta' (respuestas_adjuntos, correos entrantes), 'envio'
// (envios_adjuntos, adjuntos de respuestas salientes) o 'repo'
// (adjuntos_repo, biblioteca reutilizable de Ajustes → Adjuntos).
